package A04Encapsulation.E04PizzaCalories2;
...
public class Pizza {
    ...
    private void setName(String name) {
        if (name == null || name.isBlank() || name.length() > 15) {
            throw new IllegalArgumentException("A04Encapsulation.E04PizzaCalories2.Pizza name should be between 1 and 15 symbols.");
        }
        this.name = name;
    }
